...
public enum Music {
    ...
    CAT("Cat", "C418", Sound.MUSIC_DISC_CAT, Material.MUSIC_DISC_CAT, 188),
    BLOCKS("Blocks", "C418", Sound.MUSIC_DISC_BLOCKS, Material.MUSIC_DISC_BLOCKS, 348),
    CHIRP("Chirp", "C418", Sound.MUSIC_DISC_CHIRP, Material.MUSIC_DISC_CHIRP, 190),
    ...
    RELIC("Relic", "Aaron Cherof", Sound.MUSIC_DISC_RELIC, Material.MUSIC_DISC_RELIC, 223),
